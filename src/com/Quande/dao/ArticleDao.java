package com.Quande.dao;

import com.Quande.util.JdbcUtil;
import com.Quande.model.Article;
import com.Quande.model.Pager;
...
public class ArticleDao {
    ...
    public Pager<Article> findArticle(Article searchModel, int pageNum, int pageSize) {
        ...
        StringBuilder sql = new StringBuilder("select a.*,m.main_name,s.sub_name from " +
